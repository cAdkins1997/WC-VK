...
std::optional<GLTFData> wcvk::meshes::load_gltf(const std::filesystem::path &filePath, commands::UploadContext& context) {
    fastgltf::Parser parser;
    ...
    for (auto& material : gltf.materials) {
        ...
        newMaterial->baseColorFactors = {
            material.pbrData.baseColorFactor[0],
            material.pbrData.baseColorFactor[1],
            material.pbrData.baseColorFactor[2],
            material.pbrData.baseColorFactor[3]
        };
        newMaterial->mrFactors[0] = material.pbrData.metallicFactor;
        newMaterial->mrFactors[1] = material.pbrData.roughnessFactor;

        gltfData.materials.push_back(newMaterial);
    }
